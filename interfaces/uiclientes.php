            ...
            <div class="card shadow-sm border-0">
                <div class="card-body text-center text-md-start">
                    <figure class="banner mb-3">
                        <img class="img-fluid rounded-3" src="../img/rrhh.png" alt="Banner de clientes">
                    </figure>
                    <h1 class="titulointerface h3 mb-0">Gestión de clientes</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    if (isset($_REQUEST['bttbuscar'])) {
                        $obj->buscar($_REQUEST['txtbuscar']);
                    }

                    if (isset($_REQUEST['bttsel'])) {
                        $obj->mostrarModificar($_REQUEST['bttsel']);
                    }

                    if (isset($_REQUEST['bttmod'])) {
                        $obj->modificarCliente($_REQUEST);
                    }

                    if (isset($_REQUEST['btteli'])) {
                        $obj->eliminarCliente($_REQUEST['btteli']);
                    }
